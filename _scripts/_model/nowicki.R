...
lithology <- project(lithology,slope,method='near')
pgv <- project(pgv,slope,method='near')
lc <- project(lc,slope,method='near')
...
writeRaster(si,'~/Documents/Projects/PRSN/Hazus/Data/Spatial/Raster/landslide_si_5m.tif',
            overwrite=TRUE)
